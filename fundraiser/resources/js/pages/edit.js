...
//         const existingImage = document.querySelector('.preview-item img, .main-image img'); // sena nuotrauka
//         const deleteMain = document.getElementById('delete-main-image');


//         let hasError = false;
//         let hasMainImage =
//             (existingImage && !deleteMain?.value) ||
...
//         // 🔥 jei įkėlė naują → NENAUDOJAM delete
...
// 🔥 jei įkeli naują → nuimam delete flag
if (mainInput) {
    mainInput.addEventListener('change', () => {
        if (deleteMain) deleteMain.value = '';
    });
